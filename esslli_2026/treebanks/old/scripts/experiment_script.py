...
corpus = [("<#",) + sentence + ("#>",) for sentence in raw_corpus.keys()]
distr = rt.RadixTrie()
distr.setup(corpus)
...
most_frequent_target_seqs = sort_by_freqs(all_target_seqs, distr)[:25]
...
def main(n, always_shuffle=False):
    ...
    pickle.dump(result_dict, open(f"full_results_03_11.pkl", "wb"))
