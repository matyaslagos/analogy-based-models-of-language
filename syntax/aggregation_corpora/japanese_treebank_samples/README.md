...
- Category-specific rule currently implemented:
  - For NP extraction, NP-category matches are kept only if they are non-unary, or unary with child label not `PRO`.
